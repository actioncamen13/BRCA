...
import "./SpicmacayFooter.css";
import { Link } from "react-router-dom";

function SpicmacayFooter() {
  return (
    <div className="spicmacayfooter">
      <div className="spicmacayfooter__logo"></div>
      <div className="spicmacayfooter__text1">
        <h3>Contact us on</h3>
        <h3>enter email</h3>
      </div>
      <div className="spicmacayfooter__text2">
      ...
      <div className="spicmacayfooter__text3">
...
export default SpicmacayFooter;
