...
import "./PFCFooter.css";
import { Link } from "react-router-dom";

function PFCFooter() {
  return (
    <div className="pfcfooter">
      <div className="pfcfooter__logo"></div>
      <div className="pfcfooter__text1">
        <h3>Contact us on</h3>
        <h3>enter email</h3>
      </div>
      <div className="pfcfooter__text2">
      ...
      <div className="pfcfooter__text3">
