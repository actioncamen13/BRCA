...
function TDFooter() {
  return (
    <div className="tdfooter" style={{ position: "relative" }}>
      <a className="tdfooter__logo" href="/" style={{ textDecoration: "none" }}>
        {" "}
      </a>
      <div className="tdfooter__text1">
        <h3>Contact us on</h3>
        <h3>enter email</h3>
      </div>
      <div className="tdfooter__text2">
