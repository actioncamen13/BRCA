...
import "./DebatingFooter.css";
import { Link } from "react-router-dom";

function DebatingFooter() {
  return (
    <div className="debatingfooter">
      <a
        className="debatingfooter__logo"
        href="/"
        style={{ textDecoration: "none" }}
      > </a>
      <div className="debatingfooter__text1">
        <h3>Contact us on</h3>
        <h3>enter email</h3>
      </div>
      <div className="debatingfooter__text2">
      ...
      <div className="debatingfooter__text3">
